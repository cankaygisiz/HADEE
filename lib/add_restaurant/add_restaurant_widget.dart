...
import 'add_restaurant_model.dart';
export 'add_restaurant_model.dart';

class AddRestaurantWidget extends StatefulWidget {
  const AddRestaurantWidget({Key? key}) : super(key: key);
...
class _AddRestaurantWidgetState extends State<AddRestaurantWidget>
  ...
  late AddRestaurantModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddRestaurantModel());
                            ...
                            onPressed: () async {
                              ...
                              await RestaurantsRecord.collection
                                  ...
                                  .set(createRestaurantsRecordData(
                                    ...
                                    img: _model.textController4.text,
                                    email: _model.emailAddressController.text,
                                  ));

                              context.goNamedAuth(
                                  'RestaurantList', context.mounted);
                            },
                            text: 'Confirm',
