...
import 'dishes_list_model.dart';
export 'dishes_list_model.dart';
...
class _DishesListWidgetState extends State<DishesListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DishesListModel());
  }
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    StreamBuilder<RestaurantsRecord>(
                      stream: RestaurantsRecord.getDocument(widget.restRef!),
