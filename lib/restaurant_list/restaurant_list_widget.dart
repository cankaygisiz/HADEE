...
export 'restaurant_list_model.dart';
...
class _RestaurantListWidgetState extends State<RestaurantListWidget> {
  late RestaurantListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestaurantListModel());
  }
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onLongPress: () async {
                                  if (listViewRestaurantsRecord.email ==
                                      currentUserEmail) {
                                    context.pushNamed(
                                      'AddDish',
                                      queryParameters: {
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: AutoSizeText(
                                                listViewRestaurantsRecord.desc
                                                    .maybeHandleOverflow(
                                                  maxChars: 70,
                                                  replacement: '…',
                                                ),
